...
NDefines.NMilitary.MAX_DIVISION_SUPPORT_WIDTH = 1			-- Max width of support in division designer. (BFFU 1.19: single vertical column)
NDefines.NMilitary.MAX_DIVISION_SUPPORT_HEIGHT = 6		-- Max height of support in division designer. (BFFU 1.19: 6 support companies total, stacked vertically)
...
NDefines.NFactions.MAX_FACTION_THEATERS = 2
NDefines.NFactions.FACTION_UNLOCK_COMMANDER_COST = 0
